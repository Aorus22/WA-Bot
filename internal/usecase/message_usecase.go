...
func (uc *MessageUseCase) GetMessages(chatID string, limit int, before int64, after int64) ([]repository.Message, error) {
	return uc.msgStore.GetMessages(chatID, limit, before, after)
}
